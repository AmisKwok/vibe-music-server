...
import com.amis.vibemusicserver.service.*;
import com.amis.vibemusicserver.utils.BindingResultUtil;
...
public class AdminController {
    ...
    @Cacheable(cacheNames = "songCache", key = "#songDTO.pageNum.toString() + '-' + #songDTO.pageSize.toString() + '-' + #songDTO.songName + '-' + #songDTO.album + '-' + #songDTO.artistId.toString()")
