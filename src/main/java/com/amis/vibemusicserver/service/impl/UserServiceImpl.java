...
import com.amis.vibemusicserver.enumeration.UserStatusEnum;
import com.amis.vibemusicserver.exception.BusinessException;
import com.amis.vibemusicserver.mapper.UserMapper;
...
import com.amis.vibemusicserver.service.IUserService;
import com.amis.vibemusicserver.utils.JwtUtil;
import com.amis.vibemusicserver.utils.RsaUtil;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public void logout(String refreshToken) {
        ...
        try {
            ...
            // 3. 获取关联的accessToken
            String accessToken = stringRedisTemplate.opsForValue().get("access_token:" + refreshToken);

            // 4. 清理所有相关token
            stringRedisTemplate.delete(refreshToken); // 删除refresh token本身
            stringRedisTemplate.delete("access_token:" + refreshToken); // 删除映射关系
            stringRedisTemplate.delete("user_token:" + userId); // 删除SSO控制记录

            if (accessToken != null) {
                stringRedisTemplate.delete(accessToken); // 删除access token本身
            }
